        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            yield "</td>
                                <td>
                                    ";
            // line 33
            if (CoreExtension::getAttribute($this->env, $this->source, $context["user"], "image", [], "any", false, false, false, 33)) {
                // line 34
                yield "                                        <img src=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(CoreExtension::getAttribute($this->env, $this->source, $context["user"], "image", [], "any", false, false, false, 34)), "html", null, true);
...
";
    ...
    {
        return array (  195 => 53,  189 => 49,  180 => 45,  178 => 44,  170 => 41,  166 => 40,  162 => 38,  158 => 36,  152 => 34,  150 => 33,  145 => 31,  141 => 30,  137 => 29,  133 => 28,  129 => 27,  126 => 26,  121 => 25,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
                    ...
                    <tbody>
                        {% for user in users %}
                            <tr>
                                ...
                                <td>
                                    {% if user.image %}
                                        <img src=\"{{ asset(user.image) }}\" alt=\"User Image\" class=\"img-thumbnail\" style=\"max-width: 100px;\">
                                    {% else %}
                                        <span>No Image</span>
                                    {% endif %}
                                </td>
...
{% endblock %}
", "user/index.html.twig", "C:\\xampp\\htdocs\\Esprit\\Esprit\\templates\\user\\index.html.twig");
    }
}
