...
class __TwigTemplate_58a70dbec78f82e0df1aebbfd4f94888 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $this->parent = $this->loadTemplate("dashboard.html.twig", "facture/edit.html.twig", 1);
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        <div class=\"card-header\">
            <h4 class=\"card-title\">Modifier la facture</h4>
        </div>
        <div class=\"card-body\">
            ";
        // line 11
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 11, $this->source); })()), 'form_start', ["attr" => ["class" => "form-styled", "id" => "editFactureForm"]]);
        yield "
        ...
        yield "
                <div class=\"form-actions mt-4\">
                    <button type=\"submit\" class=\"btn btn-primary\" onclick=\"return validateForm()\">Enregistrer</button>
                    <a href=\"";
        // line 36
...
{% block content %}
    <div class=\"card\">
        ...
        <div class=\"card-body\">
            {{ form_start(form, {'attr': {'class': 'form-styled', 'id': 'editFactureForm'}}) }}
            ...
            <div class=\"form-container\">
                {% for field in form %}
                    <div class=\"form-group\">
                        ...
                        {# Render the form field with Bootstrap styling #}
...
{% endblock %}
", "facture/edit.html.twig", "C:\\xampp\\htdocs\\Esprit\\Esprit\\templates\\facture\\edit.html.twig");
    }
}
